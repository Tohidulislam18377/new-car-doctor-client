...
const Login = () => {
    const { logInUser, resetPassword, sinInGoogle } = useContext(AuthContext);
    UseTitle('Login')
                    ...
                    <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                        <form onSubmit={handelLogin} className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <input style={{ border: '1px solid black' }} type="email" name='email' ref={useEmail} placeholder="email" className="outline-none pl-3 pt-2 pb-2 rounded" required />
                            </div>
                            <div className="form-control">
                                <label className="label">
                                ...
                                <label className="label">
                                    <button onClick={handelResetPassword} className="label-text-alt link link-hover">Forget Password</button>
                                </label>
                            </div>
                            <div className="form-control">
                                <input className=" p-3 rounded hover:text-white bg-[#FF3811]" type="submit" value="Login" />
                            </div>
                            <div className='text-center'>
                                ...
                                <p>Have an account? <Link className='text-[#FF3811] hover:underline' to={'/singUP'}>SingUp</Link></p>
                            </div>
                        </form>
                    </div>
                </div>
